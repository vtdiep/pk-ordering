...
import { ViewCheckoutButton } from "./ViewCheckoutButton";
...
export const Home = () => {
    ...
    useEffect(() => {
     ...
     return (<><Header /><div id="hero_image_container">
         <picture>
             <img id="hero_image" src="pekoe_2000.jpg" alt="" />
         </picture>
     </div><Store></Store><ViewCheckoutButton /><header className="App-header">
