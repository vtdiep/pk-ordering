...
export function Match< K extends string, T extends { [$K in K]:U }, U>(
    failedValidationMsg:string, property: K, predicate: (thisProp:U, otherProp: U) => boolean, validationOptions?: ValidationOptions) {
...
export class MatchConstraint implements ValidatorConstraintInterface {
    ...
    defaultMessage(args: ValidationArguments) {
      const [relatedPropertyName, predicateFunction, failedValidationMsg] = args.constraints;
